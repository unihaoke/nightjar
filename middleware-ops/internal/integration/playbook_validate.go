...
//   - v5：`docker run` 里 Exporter 自己的参数（--web.listen-address、模板参数）统一排到
//     **镜像之后**（INC-010：放在镜像前会被 docker 当成自己的选项，报 unknown flag、rc=125）。
//
// 变更渲染模板时请同步 +1，并在 docs/POSTMORTEM.md 里记录原因。
const PlaybookRendererVersion = "mwops-playbook v5"
