...
type MetricSpec struct {
	...
	// HigherIsWorse 为 false 时表示数值越高越健康（如命中率）。
	HigherIsWorse bool
	// Generator 为模拟器的生成参数。
...
var profiles = map[string]Profile{
	"redis": {
		MWType: "redis",
		Metrics: []MetricSpec{
			{Name: "memory_usage_percent", DisplayName: "内存使用率", Unit: "%", Category: "resource", HigherIsWorse: true,
			...
			{Name: "connected_clients", DisplayName: "连接数", Unit: "", Category: "resource", HigherIsWorse: true,
			...
			{Name: "instantaneous_ops_per_sec", DisplayName: "QPS", Unit: "", Category: "performance", HigherIsWorse: true,
			...
			{Name: "keyspace_hit_rate", DisplayName: "命中率", Unit: "%", Category: "performance", HigherIsWorse: false,
			...
			{Name: "db_keys", DisplayName: "key 数量", Unit: "", Category: "resource", HigherIsWorse: true,
			...
			{Name: "slowlog_length", DisplayName: "慢查询数", Unit: "", Category: "reliability", HigherIsWorse: true,
			...
			{Name: "evicted_keys", DisplayName: "淘汰 key 数", Unit: "", Category: "reliability", HigherIsWorse: true,
			...
			{Name: "blocked_clients", DisplayName: "阻塞客户端", Unit: "", Category: "reliability", HigherIsWorse: true,
	...
	"kafka": {
		MWType: "kafka",
		Metrics: []MetricSpec{
			{Name: "broker_up", DisplayName: "Broker 状态", Unit: "", Category: "reliability", HigherIsWorse: false,
				Expr:             `up{selector}`,
				WarningThreshold: 1, CriticalThreshold: 1, Generator: SeriesSpec{Base: 1, Amplitude: 0, Noise: 0}},
			{Name: "partition_count", DisplayName: "Topic 分区数", Unit: "", Category: "resource", HigherIsWorse: false,
			...
			{Name: "consumer_lag", DisplayName: "消费者组 Lag", Unit: "", Category: "performance", HigherIsWorse: true,
			...
			{Name: "produce_rate", DisplayName: "生产速率", Unit: "/s", Category: "performance", HigherIsWorse: false,
			...
			{Name: "consume_rate", DisplayName: "消费速率", Unit: "/s", Category: "performance", HigherIsWorse: false,
			...
			{Name: "under_replicated_partitions", DisplayName: "ISR 副本不足分区", Unit: "", Category: "reliability", HigherIsWorse: true,
	...
	"mysql": {
		MWType: "mysql",
		Metrics: []MetricSpec{
			{Name: "qps", DisplayName: "QPS", Unit: "", Category: "performance", HigherIsWorse: true,
			...
			{Name: "tps", DisplayName: "TPS", Unit: "", Category: "performance", HigherIsWorse: false,
			...
			{Name: "threads_connected", DisplayName: "连接数", Unit: "", Category: "resource", HigherIsWorse: true,
			...
			{Name: "slow_queries", DisplayName: "慢查询数", Unit: "", Category: "reliability", HigherIsWorse: true,
			...
			{Name: "buffer_pool_hit_rate", DisplayName: "缓冲池命中率", Unit: "%", Category: "performance", HigherIsWorse: false,
			...
			{Name: "replication_lag_seconds", DisplayName: "主从延迟", Unit: "s", Category: "reliability", HigherIsWorse: true,
	...
	"pg": {
		...
		Metrics: []MetricSpec{
			...
			{Name: "connections", DisplayName: "连接数", Unit: "", Category: "resource", HigherIsWorse: true,
			...
			{Name: "cache_hit_rate", DisplayName: "缓存命中率", Unit: "%", Category: "performance", HigherIsWorse: false,
			...
			{Name: "lock_waits", DisplayName: "锁等待", Unit: "", Category: "reliability", HigherIsWorse: true,
	...
	"es": {
		MWType: "es",
		Metrics: []MetricSpec{
			{Name: "cluster_status", DisplayName: "集群健康状态", Unit: "", Category: "reliability", HigherIsWorse: false,
			...
			{Name: "node_count", DisplayName: "节点数", Unit: "", Category: "resource", HigherIsWorse: false,
				Expr:             `elasticsearch_cluster_health_number_of_nodes{selector}`,
				WarningThreshold: 3, CriticalThreshold: 1, Generator: SeriesSpec{Base: 5, Amplitude: 0, Noise: 0}},
			{Name: "index_count", DisplayName: "索引数量", Unit: "", Category: "resource", HigherIsWorse: false,
			...
			{Name: "search_rate", DisplayName: "搜索速率", Unit: "/s", Category: "performance", HigherIsWorse: false,
			...
			{Name: "indexing_rate", DisplayName: "索引速率", Unit: "/s", Category: "performance", HigherIsWorse: false,
			...
			{Name: "jvm_heap_used_percent", DisplayName: "JVM 堆使用率", Unit: "%", Category: "resource", HigherIsWorse: true,
			...
			{Name: "unassigned_shards", DisplayName: "未分配分片", Unit: "", Category: "reliability", HigherIsWorse: true,
	...
	"nginx": {
		MWType: "nginx",
		Metrics: []MetricSpec{
			{Name: "active_connections", DisplayName: "活跃连接数", Unit: "", Category: "resource", HigherIsWorse: true,
			...
			{Name: "request_rate", DisplayName: "请求速率", Unit: "/s", Category: "performance", HigherIsWorse: false,
			...
			{Name: "error_rate_5xx", DisplayName: "错误率(5xx)", Unit: "%", Category: "reliability", HigherIsWorse: true,
			...
			{Name: "upstream_response_time", DisplayName: "响应时间(P95)", Unit: "ms", Category: "performance", HigherIsWorse: true,
	...
	"rabbitmq": {
		MWType: "rabbitmq",
		Metrics: []MetricSpec{
			{Name: "queue_messages", DisplayName: "队列消息数", Unit: "", Category: "performance", HigherIsWorse: true,
			...
			{Name: "consumers", DisplayName: "消费者数", Unit: "", Category: "resource", HigherIsWorse: false,
